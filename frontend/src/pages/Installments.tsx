          ...
          <>
            <div className="table-container">
              <table className="table">
                <thead>
                  <tr>
                    <th>#</th><th>Client</th><th>Policy</th><th>Due Date</th>
                  ...
                  {installments.map(inst => {
                    ...
                    return (
                      <tr key={inst.id}>
                        ...
                        <td className={inst.status === 'overdue' ? 'text-red-600 font-medium' : ''}>
                          {formatDate(inst.dueDate)}
                          {inst.status === 'overdue' && <div className="text-xs text-red-500">{inst.overdueDays}d overdue</div>}
                        </td>
      ...
      <Modal isOpen={!!paymentModal} onClose={() => setPaymentModal(null)} title="Record Payment">
        {paymentModal && (
          <PaymentForm
            ...
            onSave={() => { setPaymentModal(null); fetchAll(); }}
